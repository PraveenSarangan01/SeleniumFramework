...
public class TC005 extends MagentoBase {
@Test(dataProvider ="login",dataProviderClass = MagentoDataprovider.class)
public void VerifyLogintakeScreen(String data[]) throws FileNotFoundException, IOException {
...
void TakeScreenShot() {
	...
	try {
		FileUtils.copyFile(screenshotAs, new File("./snaps/"+"image.png"));
	} catch (IOException e) {
